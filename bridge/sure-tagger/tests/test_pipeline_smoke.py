...
class PipelineSmokeTest(unittest.TestCase):
    ...
    def test_ami_utterance_record_mapping(self):
        ...
        self.assertTrue(validate_manifest_record(record))
        self.assertEqual(record["sample"]["sample_id"], "AMI:ES2002a:ES2002a_utt_00002")
        self.assertEqual(record["sample"]["native_metadata"]["granularity"], "utterance")
        self.assertEqual(record["sample"]["native_metadata"]["speaker_id"], "B")
        self.assertEqual(record["sample"]["audio"]["start_sec"], 55.415)
    ...
    def test_build_utterance_manifest_from_jsonl_dir(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(records[0]["sample"]["native_metadata"]["utterance_id"], "ES2002a_utt_00000")
