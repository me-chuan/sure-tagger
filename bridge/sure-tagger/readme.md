...
```text
sample_id = AMI:<audio_id>:<utt_id>
granularity = utterance
meeting_id = audio_id
speaker_id = speaker
audio.start_sec = start
audio.end_sec = end
...
```json
{
  ...
  "sample": {
    "sample_id": "AMI:ES2002a:ES2002a_utt_00002",
    "audio": {
      "path": "",
      "start_sec": 55.415,
      "end_sec": 77.456
    ...
    "text": {
      ...
      "normalized_transcript": "Um well this is the kick-off meeting."
    },
    "native_metadata": {
      "granularity": "utterance",
      "meeting_id": "ES2002a",
      "audio_id": "ES2002a",
      "utterance_id": "ES2002a_utt_00002",
      "speaker_id": "B",
    ...
    "provenance": {
      "source_path": "/hpc_stor03/sjtu_home/huifei.wang/dataset/all/ES2002a.jsonl",
      "source_split": "all",
      "source_line": 3
    }
  }
