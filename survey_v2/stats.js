const SESSIONS_KEY = 'sure-tagger-survey-v2-sessions-v1';
...
async function importFiles(files) {
  ...
  for (const file of files) {
    try {
      ...
      if (payload.format !== 'sure-tagger-survey-v2/v1' || !payload.session_id || !Array.isArray(payload.answers)) continue;
      const answers = {};
      const submitted = [];
